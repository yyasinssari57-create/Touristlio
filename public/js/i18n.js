window.TL_I18N = (function () {
  ...
  const dict = {
    tr: {
      ...
      authSecure: '🔒 Güvenli şifreleme ile korunuyor · KVKK & GDPR uyumlu',
      authOr: '— veya —',
      ...
      filterSheetOpen: 'Filtrele', filterSheetTitle: 'Filtrele', filterApply: 'Uygula',
      ...
      firstTiolaCta: "İlk Tiola'yı sen yaz!",
      noRating: 'Yıldızsız',
      ...
      logoHomeAlt: 'Touristlio ana sayfaya git',
      sortAria: 'Sıralama',
      ...
      cookieMsg: 'Zorunlu çerezlerin yanında, onayınız olursa ziyaret analitiği (sayfa görüntüleme, olaylar, Core Web Vitals ve isteğe bağlı Google Analytics 4) kullanırız. KVKK detayları için politikalara bakın.',
    ...
    en: {
      ...
      authSecure: '🔒 Protected with secure encryption · GDPR compliant',
      authOr: '— or —',
      ...
      filterSheetOpen: 'Filter', filterSheetTitle: 'Filter', filterApply: 'Apply',
      ...
      firstTiolaCta: 'Write the first Tiola!',
      noRating: 'No stars',
      ...
      logoHomeAlt: 'Touristlio go to homepage',
      sortAria: 'Sort',
      ...
      cookieMsg: 'Besides essential cookies, we only run visit analytics (page views, events, Core Web Vitals, and optional Google Analytics 4) if you consent. See our KVKK/GDPR policies.',
      cookieAccept: 'Accept',
      cookieReject: 'Reject',
      privacyLink: 'Privacy',
      aboutTitle: 'About us',
