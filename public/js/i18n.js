window.TL_I18N = (function () {
  const dict = {
    tr: {
      ...
      osmSearchSoon: '🗺️ Haritada keşfet',
      osmHint: 'Aradığınız yer listede yok mu? Haritada OpenStreetMap ile keşfedin.',
      ...
      settingsNewPassword: 'Yeni şifre (min 8 karakter)',
      ...
      settingsNote: 'Şifre en az 8 karakter, bir büyük harf ve bir rakam içermelidir.',
    ...
    en: {
      ...
      osmSearchSoon: '🗺️ Explore on map',
      osmHint: 'Place not in our list? Explore it on the OpenStreetMap tab.',
      ...
      settingsNewPassword: 'New password (min 8 characters)',
      ...
      settingsNote: 'Password must be at least 8 characters with one uppercase letter and one number.',
