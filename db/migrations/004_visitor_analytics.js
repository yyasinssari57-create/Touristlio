...
function up(db, { tableExists, columnExists, addColumnIfMissing }) {
  ...
  ensureIndex(db, 'idx_analytics_sessions_last_seen', 'analytics_sessions', 'last_seen_at');
  ensureIndex(db, 'idx_analytics_sessions_started', 'analytics_sessions', 'started_at');
  ensureIndex(db, 'idx_analytics_events_created', 'analytics_events', 'created_at');
  ensureIndex(db, 'idx_analytics_events_session', 'analytics_events', 'session_id');
  ensureIndex(db, 'idx_analytics_events_tab', 'analytics_events', ['tab', 'created_at']);
